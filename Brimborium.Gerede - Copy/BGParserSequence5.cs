...
public interface IBGCombiner<TResult, T1, T2, T3, T4, T5> {
    TResult Combine(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5);
}

public class BGParserSequence<TResult, T1, T2, T3, T4, T5>
    : IBGParser<TResult> {
    ...
    public readonly IBGCombiner<TResult, T1, T2, T3, T4, T5> Combiner;
    ...
    public BGParserSequence(
        ...
        IBGCombiner<TResult, T1, T2, T3, T4, T5> combiner
    ) {
    ...
    public bool Parse(
        ...
        var matchMatch = input.Input[0 .. next5.Input.End];
        var matchValue = this.Combiner.Combine(match1.Value, match2.Value, match3.Value, match4.Value, match5.Value);
...
public class BGCombiner<TResult, T1, T2, T3, T4, T5>
    : IBGCombiner<TResult, T1, T2, T3, T4, T5> {
    private readonly Func<T1, T2, T3, T4, T5, TResult> _Combiner;
    ...
    public TResult Combine(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5) {
        return _Combiner(value1, value2, value3, value4, value5);
    }
}