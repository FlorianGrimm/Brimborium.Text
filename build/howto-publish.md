...
nuget SetApiKey x
dotnet nuget push Brimborium.Text.1.0.4.nupkg --source https://api.nuget.org/v3/index.json
dotnet nuget push Brimborium.Text.1.0.4.snupkg --source https://api.nuget.org/v3/index.json